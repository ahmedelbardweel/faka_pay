<x-app-layout>
    ...
    <style>
        ...
        .icon-box { width: 4rem; height: 4rem; background: #fff; border-radius: 0; border: 1px solid #10b981; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; color: #10b981; }
        .card-title { font-size: 1.5rem; font-weight: 800; color: #111827; margin-bottom: 0.5rem; text-transform: uppercase; letter-spacing: 0.05em; }
        ...
        .amount-input:focus { outline: none; border-color: #10b981; box-shadow: 4px 4px 0px 0px rgba(16, 185, 129, 0.1); }
        ...
        .cancel-link { display: inline-block; margin-top: 1.5rem; color: #111827; font-weight: 800; text-transform: uppercase; font-size: 0.75rem; letter-spacing: 0.1em; text-decoration: none; transition: all 0.2s; border: 1px solid #e5e7eb; padding: 0.5rem 1rem; }
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="wallet-container">
            <div class="wallet-card">
                <div class="icon-box">
                    <svg style="width:2rem;height:2rem" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                </div>
                <h3 class="card-title">{{ __('Add Funds') }}</h3>
                <p class="card-desc">{{ __('Enter the amount you wish to add to your balance') }}</p>
